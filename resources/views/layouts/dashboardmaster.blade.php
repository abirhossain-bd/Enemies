...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/tkx4yy6dgoz3jm55nfoi1jlhm4dua8zakljg2aai35dl9jlv/tinymce/7/tinymce.min.js" referrerpolicy="origin"></script>
</head>
                ...
                <ul class="app-menu">
                    ...
                    <li class="menu-item">
                        <a class='menu-link waves-effect waves-light' href='{{ route('profile.index') }}'>
                            <span class="menu-icon"><i class="fa-solid fa-face-smile"></i></i></span>
                  ...
                  @if (auth()->user()->role == 'manager' || auth()->user()->role == 'admin' || auth()->user()->role == 'blogger')
                      <li class="menu-item">
                        ...
                        <li class="dropdown">
                            <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                                ...
                                @if (auth()->user()->attempt_role == 'third_party')
                                    ...
                                    <img src="{{ asset('uploads/default/default.jpeg') }}" alt="user-image" class="rounded-circle">
                                @else
                                    @if (auth()->user()->image == 'default.jpeg')
